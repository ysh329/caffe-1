...
#ifdef USE_CNMEM
  Caffe::mallocGPU(&this->tempData1, this->tempDataSize);
  Caffe::mallocGPU(&this->tempData2, this->tempDataSize);
#endif
...
#ifdef USE_CNMEM
  Caffe::freeGPU(this->tempData1);
  Caffe::freeGPU(this->tempData2);
#endif
}
